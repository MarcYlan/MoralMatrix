...
// NOTE: we moved `page_buttons.php` into the HTML <aside> so it appears in the drawer
...
<body>
    ...
    <!-- Top-center hamburger to open the drawer -->
    ...
    <aside id="sidebar" class="sidebar" aria-hidden="true">
      ...
      <div class="sidebar-links" id="pageButtons">
  ...
  <div class="profile-meta">
    ...
    <div class="category-picker">
        ...
        <select id="offense_category" name="offense_category" onchange="toggleForms()" required>
      ...
      <!-- LIGHT -->
      <div id="lightForm" class="form-container" style="display:none">
      ...
      <!-- MODERATE -->
      <div id="moderateForm" class="form-container" style="display:none">
        <form method="POST" enctype="multipart/form-data">
      ...
      <!-- GRAVE -->
      <div id="graveForm" class="form-container" style="display:none">
        <form method="POST" enctype="multipart/form-data">
          <p>Grave Offenses</p>
