...
<!-- SECURITY -->
    ...
    <h3>Security Registration</h3>
        <form method="POST" enctype="multipart/form-data">
            ...
            <label>Temporary Password:</label>
            <input type="text" name="password" id="student_password" required>
            <button type="button" onclick="generatePass('student_password')">Generate</button>

            <!-- Preview directly under the password row -->
            <img id="studentPreview" class="preview-under-pass" alt="Preview">
